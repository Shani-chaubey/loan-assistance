...
export interface TeamItem { _id: string; name: string; role: string; description: string; image: string; order: number }
...
const FALLBACK_SERVICES: ServiceItem[] = [
  { _id: "1", icon: "flaticon-money", rate: "9.35%", title: "Personal Loan", amount: "₹2,00,000", tenure: "Up to 60 months", desc: "Ideal for urgent expenses, travel plans, medical support.", features: ["No collateral", "Instant e-approval", "Flexible EMI"], color: "#2cbbdf", order: 1 },
...
const FALLBACK_WHY: WhyItem[] = [
  { _id: "1", icon: "icofont-flash", title: "Lightning Fast Approval", desc: "Approved within 24 hours.", color: "#2cbbdf", bg: "rgba(44,187,223,0.10)", order: 1 },
...
const FALLBACK_TEAM: TeamItem[] = [
  { _id: "1", name: "Roxanne Bryant", role: "Managing Director", description: "Leads the company with 15+ years in financial services and a passion for client success.", image: "/images/team/1.png", order: 1 },
  { _id: "2", name: "Dominic Jefferson", role: "Head of Marketing", description: "Drives brand growth and customer engagement through data-driven marketing strategies.", image: "/images/team/2.png", order: 2 },
  { _id: "3", name: "Mercedes Baldwin", role: "General Manager", description: "Oversees daily operations ensuring seamless loan processing and team performance.", image: "/images/team/3.png", order: 3 },
  { _id: "4", name: "Gertrude Keller", role: "Commercial Manager", description: "Manages key commercial partnerships and helps businesses secure the right financing.", image: "/images/team/4.png", order: 4 },
];
...
const FALLBACK_PARTNERS: PartnerItem[] = [
  ...
  { _id: "a1", type: "award", name: "Best Loan Provider 2024", icon: "icofont-badge", color: "#2cbbdf", org: "Finance India Awards", text: "", order: 7 },
  ...
  { _id: "c1", type: "certification", name: "256-bit SSL Encrypted", icon: "icofont-lock", color: "#2cbbdf", org: "", text: "256-bit SSL Encrypted", order: 11 },
