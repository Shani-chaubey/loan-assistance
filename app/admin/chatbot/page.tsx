        ...
        return (
          <div style={{ background: "#fff", borderRadius: 14, padding: 16, boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
              <div style={{ width: 34, height: 34, borderRadius: "50%", background: "linear-gradient(135deg,#8180e0,#6c6bcc)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 2 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                  ...
                  {item.isQuickReply && (
                    <span style={{ fontSize: 11, background: "rgba(129,128,224,0.12)", color: "#8180e0", padding: "2px 8px", borderRadius: 10, fontWeight: 600, flexShrink: 0 }}>Quick Reply</span>
                  )}
                </div>
                ...
                {item.keywords && item.keywords.length > 0 && (
                  <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
                    {item.keywords.slice(0, 5).map((kw: string, i: number) => (
                      <span key={i} style={{ fontSize: 11, background: "#f5f5ff", color: "#8180e0", padding: "2px 8px", borderRadius: 8, border: "1px solid #e8e8f5" }}>{kw}</span>
                    ))}
              ...
              <div style={{ display: "flex", gap: 5, flexShrink: 0 }}>
                <button onClick={onEdit} title="Edit" style={{ border: "none", background: "rgba(129,128,224,0.10)", color: "#8180e0", width: 32, height: 32, borderRadius: 8, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
