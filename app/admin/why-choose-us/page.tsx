  ...
  return (
    <AdminCrud
      ...
      fields={[
        ...
        { key: "bg",    label: "Background (e.g. rgba(...))", placeholder: "rgba(129,128,224,0.10)" },
        { key: "order", label: "Sort Order",     type: "number", placeholder: "1" },
      ]}
      defaultValues={{ title: "", desc: "", icon: "icofont-flash", color: "#8180e0", bg: "rgba(129,128,224,0.10)", order: 0 }}
