  ...
  return (
    <AdminCrud
      ...
      fields={[
        ...
        { key: "color", label: "Accent Color", placeholder: "#2cbbdf" },
      ...
      defaultValues={{ type: "partner", name: "", icon: "icofont-bank", color: "#2cbbdf", org: "", text: "", order: 0 }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1 }}>
              ...
              <div>
                <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                  ...
                  <span style={{ fontSize: 11, background: "#f0f0f8", padding: "2px 8px", borderRadius: 8, color: "#2cbbdf", fontWeight: 600, textTransform: "capitalize" }}>{item.type}</span>
                </div>
