...
const statsData = [
  { icon: "icofont-people",       value: "25,000+", label: "Happy Customers",  color: "#2cbbdf", order: 1 },
...
const whyData = [
  { icon: "icofont-flash",          title: "Lightning Fast Approval",  desc: "Get your loan approved within 24 hours. No lengthy paperwork, no endless waiting.",                color: "#2cbbdf", bg: "rgba(44,187,223,0.10)", order: 1 },
...
const partnersData = [
  ...
  { type: "award", name: "Best Loan Provider 2024",   icon: "icofont-badge",             color: "#2cbbdf", org: "Finance India Awards",     text: "", order: 7 },
  ...
  { type: "certification", name: "256-bit SSL Encrypted", icon: "icofont-lock",          color: "#2cbbdf", org: "", text: "256-bit SSL Encrypted", order: 11 },
